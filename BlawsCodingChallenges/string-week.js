...
// fixMixUps("PR0-T1P #hqB: 1T'5 N1C3 T0 5AY H3770.")
...
function decodeHiddenMessage(str) {
	console.log(reverseString(replaceKeyChars(cleanUpString(fixMixUps(str)))))
}
...
function chooseFinalists(str) {
	...
	const noMultiplesOfFive = (str) => str.length % 5
	const oddCharCode = (str) =>
		(str.charCodeAt(0) + str.charCodeAt(str.length - 1)) % 2
...
// [ 'Pets and the Kitty', 'The Pawffice', 'Paw Trek' ]
